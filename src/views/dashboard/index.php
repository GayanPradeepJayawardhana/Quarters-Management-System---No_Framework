        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:border-amber-400 hover:ring-4 hover:ring-amber-200/50 hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center">
                <div class="w-20 h-20 flex items-center justify-center mb-4">
                    <img src="/assets/images/Request Quarters.png" alt="Home" class="w-20 h-20 object-contain">
                </div>
                ...
                <a href="/application/request" class="mt-auto bg-[#5c060d] hover:bg-[#4a050a] text-white hover:text-amber-300 font-semibold px-5 py-2 rounded-lg text-sm transition shadow-sm inline-flex items-center space-x-1">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:border-amber-400 hover:ring-4 hover:ring-amber-200/50 hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center">
                <div class="w-20 h-20 flex items-center justify-center mb-4">
                    <img src="/assets/images/View Status.png" alt="Checklist" class="w-20 h-20 object-contain">
                </div>
                ...
                <a href="/application/status" class="mt-auto bg-[#5c060d] hover:bg-[#4a050a] text-white hover:text-amber-300 font-semibold px-5 py-2 rounded-lg text-sm transition shadow-sm inline-flex items-center space-x-1">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:border-amber-400 hover:ring-4 hover:ring-amber-200/50 hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center">
                <div class="w-20 h-20 flex items-center justify-center mb-4">
                    <img src="/assets/images/Waiting List.png" alt="Waiting List" class="w-20 h-20 object-contain">
                </div>
                ...
                <a href="/waiting-list" class="mt-auto bg-[#5c060d] hover:bg-[#4a050a] text-white hover:text-amber-300 font-semibold px-5 py-2 rounded-lg text-sm transition shadow-sm inline-flex items-center space-x-1">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:border-amber-400 hover:ring-4 hover:ring-amber-200/50 hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center relative">
                ...
                <?php endif; ?>
                <div class="w-20 h-20 flex items-center justify-center mb-4">
                    <img src="/assets/images/Notification.png" alt="Bell" class="w-20 h-20 object-contain">
                </div>
                ...
                <a href="/notifications" class="mt-auto bg-[#5c060d] hover:bg-[#4a050a] text-white hover:text-amber-300 font-semibold px-5 py-2 rounded-lg text-sm transition shadow-sm inline-flex items-center space-x-1">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:border-amber-400 hover:ring-4 hover:ring-amber-200/50 hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center">
                <div class="w-20 h-20 flex items-center justify-center mb-4">
                    <img src="/assets/images/Respond to Offer.png" alt="Envelope" class="w-20 h-20 object-contain">
                </div>
                ...
                <a href="/offer/respond" class="mt-auto bg-[#5c060d] hover:bg-[#4a050a] text-white hover:text-amber-300 font-semibold px-5 py-2 rounded-lg text-sm transition shadow-sm inline-flex items-center space-x-1">
